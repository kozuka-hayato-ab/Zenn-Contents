...
```
:::
SettingsのAssemblyから`ProjectDefine`を取得しコンストラクタ`.ctor`を検索
...
以上、「[Applibot Advent Calendar 2023](https://qiita.com/advent-calendar/2023/applibot)」 9日目の記事でした。
明日は[@hoge](https://qiita.com/hoge)さんです！


## 参考記事
1. [【Unity】ILPostProcessorとasmrefを使った外部Packageのメソッド書き換え](https://qiita.com/sune2/items/bb23de9364f966ada933)
2. [C#で手軽にILや内部を確認するなら「SharpLab」！](https://qiita.com/RyotaMurohoshi/items/a6a252915f11f7559efe)